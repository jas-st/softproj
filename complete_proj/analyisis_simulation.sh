...
do
	...
	./all_tests.out -F $f -s ${s} >> results_$treename/results_raw_$treename.csv;
done

Rscript analysis.R $treefile $seq_len results_$treename/results_raw_$treename.csv results_$treename/results_$treename.csv $k ${s} --quiet >> $dir/results_$treename//simulation.log; 
